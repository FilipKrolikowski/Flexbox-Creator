      ...
      <div className={styles.block}>
        <div className={styles.item}>
          <div className={styles.title}>
            ...
            <div className={styles.color__container}>
              ...
              <label className={styles.color}>
                <input type="radio" name="accent" checked={accent === "blue"} onChange={() => changeAccent("blue")} />
        ...
        <div className={styles.item}>
          <div className={styles.title}>
            ...
            <Toggle checked={selectMultiple} onChange={() => changeSelectMultiple(!selectMultiple)} />
          </div>
        </div>
        ...
        <div className={styles.item}>
          <div className={styles.title}>
            ...
            <Toggle checked={reduceMotion || false} onChange={() => changeReduceMotion(!reduceMotion)} />
          </div>
        </div>
      </div>
