...
import { Container, ItemStyle } from "../../../types";
import { AnimatePresence, motion } from "framer-motion";
import { useEffect, useState } from "react";
import styles from "./Edit.module.scss";
import EditContainer from "./EditContainer/EditContainer";
import EditItems from "./EditItems/EditItems";
import { ContainerConfig, ItemConfig } from "../../../data/dataTypes";
  ...
  return (
    <div className={styles.edit}>
      <div className={styles.tab_switcher}>
        <div className={styles.switch} data-active={switchState === 1} onClick={() => setSwitchState(1)}>
          Container
        </div>
        <div className={styles.switch} data-active={switchState === 2} onClick={() => setSwitchState(2)}>
          Items
        </div>
      </div>
      ...
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          {switchState === 1 && (
            <EditContainer editContainer={editContainer} container={container} containerConfig={containerConfig} />
          )}
          {switchState === 2 && (
            <EditItems
