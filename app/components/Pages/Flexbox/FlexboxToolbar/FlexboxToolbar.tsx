...
export default function FlexboxToolbar() {
  ...
  return (
    <Toolbar>
      <ToolbarBtn value="Add" shortcut={OS === "Mac" ? "cmd + a" : "ctrl + a"} onClick={addItem}>
        <IoAddOutline />
      </ToolbarBtn>
      ...
      <ToolbarBtn value="Undo" shortcut={OS === "Mac" ? "cmd + z" : "ctrl + z"} onClick={undo} disabled={!canUndo}>
        <LuUndo />
      </ToolbarBtn>

      <ToolbarBtn value="Redo" shortcut={OS === "Mac" ? "cmd + y" : "ctrl + y"} onClick={redo} disabled={!canRedo}>
        <LuRedo />
      </ToolbarBtn>
    </Toolbar>
  );
