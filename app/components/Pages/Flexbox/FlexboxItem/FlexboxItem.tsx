...
import { type FlexboxItem } from "../../../../../lib/types/flexbox";
...
const FlexboxItem = forwardRef<HTMLDivElement, Props>(function FlexboxItem({ item }, ref) {
  ...
  return (
    ...
    >
      ...
      <motion.label layout transition={{ duration: 0.1 }} className={styles.text_container}>
