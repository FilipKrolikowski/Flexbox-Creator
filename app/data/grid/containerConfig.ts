...
import { LuAlignHorizontalJustifyStart, LuAlignVerticalJustifyEnd } from "react-icons/lu";
...
export const containerConfig: ContainerConfig[] = [
  {
    key: "display",
    title: "Display",
    description: "Defines the layout type of the container, such as grid or block.",
    icon: DiGhostSmall,
    type: "select",
    options: ["grid", "block"],
    defaultValue: "grid",
  },
  {
    ...
    description: "Specifies the column structure of the grid, including sizes and units.",
  ...
  },
  {
    ...
    description: "Specifies the row structure of the grid, including sizes and units.",
  ...
  },
  {
    ...
    key: "gap",
    title: "Gap",
    description: "Specifies the spacing between rows and columns in the grid.",
  ...
  },
  {
    ...
    description: "Defines the width of columns automatically added to the grid.",
    icon: LuAlignHorizontalJustifyStart,
    type: "input",
    inputType: "unit",
  ...
  },
  {
    ...
    description: "Defines the height of rows automatically added to the grid.",
    icon: LuAlignVerticalJustifyEnd,
    type: "input",
    inputType: "unit",
    unitOptions: ["auto", "fr", "px", "%"],
