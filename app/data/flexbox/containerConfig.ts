...
export const containerConfig: ContainerConfig[] = [
  ...
  },
  {
    key: "flexWrap",
    title: "Flex Wrap",
    description: "Determines whether items wrap onto multiple lines or stay on one line.",
    icon: LuWrapText,
    type: "select",
  ...
  },
  {
    ...
    description: "Aligns items along the main axis, controlling horizontal spacing.",
  ...
  },
  {
    key: "alignItems",
    title: "Align Items",
    description: "Aligns items along the cross axis, affecting vertical alignment.",
  ...
  },
  {
    key: "alignContent",
    title: "Align Content",
    description: "Defines the spacing between flex lines when wrapping occurs.",
  ...
  },
  {
    key: "gap",
    title: "Gap",
    description: "Specifies the spacing between flex items within the container.",
