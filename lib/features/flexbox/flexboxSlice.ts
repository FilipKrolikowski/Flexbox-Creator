...
import { Flexbox, FlexboxContainer, FlexboxItem, FlexboxItemStyle, FlexboxState } from "../../types/flexbox";
...
const flexboxReducer = enableHistory(flexboxSlice.reducer, "flexbox", ["items", "container"]);
...
export const selectCanUndoFlexbox = (state: RootState) => canUndo(state.flexbox);
export const selectCanRedoFlexbox = (state: RootState) => canRedo(state.flexbox);

export const selectFlexbox = createSelector([selectItems, selectContainer], (items, container) => ({
  items,
  container,
}));
